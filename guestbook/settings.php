...
/* Website title */
$settings['website_title']="Return to site";

/* Website URL */
$settings['website_url']='http://www.kera.gr/';

/* Guestbook title */
$settings['gbook_title']="Kera Apartments Guestbook";

/* Your e-mail address. */
$settings['admin_email']='me@domain.com';

/* URL of the gbook.php file. */
$settings['gbook_url']='http://www.kera.gr/guestbook/gbook.php';
