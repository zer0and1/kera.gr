...
<meta http-equiv="Content-Type" content="text/html;charset=<?php echo "utf-8"; //echo $lang['enc']; ?>" />
...
<div id="gbook_header">
		...
		<a href="gbook.php"><?php echo "Λίστα σχολίων"; //echo $lang['t60']; ?></a> |
		<a href="gbook.php?a=sign"><?php //echo $lang['t48']; 
echo "Καταχώριση σχολίου";?></a>
		<br class="clear" />
